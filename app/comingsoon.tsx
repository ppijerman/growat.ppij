...
const Comingsoon: React.FC = () => {
  ...
  const opacity = windowHeight
    ? Math.max(1 - (scrollY - 8) / windowHeight, 0)
    : 1
  ...
  return (
    <div>
      <div className="relative w-full h-screen">
        <div
          className="absolute top-0 left-0 w-full h-full bg-landing bg-cover bg-center transition-opacity duration-500"
          style={{ opacity }}
        ></div>
