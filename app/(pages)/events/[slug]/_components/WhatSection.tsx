...
export default function WhatSection({ richTextContent }: Props) {
  return (
          ...
          {richTextContent?.image ? (
            <div className="w-full flex flex-col md:flex-row">
              <div className="md:w-4/7 text-justify text-base md:pr-5">
                <MarkdownContent
                  className="prose-base text-justify"
                  markdown={richTextContent.text}
                />
              </div>
            ...
            <div className="w-full">
              <MarkdownContent
                markdown={
                  richTextContent?.text || DEFAULT_PARAGRAPHS.join("\n\n")
                }
              />
            </div>
          )}
