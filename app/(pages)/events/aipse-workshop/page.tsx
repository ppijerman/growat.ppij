...
export default function Page() {
  return (
    <div className="mb-5">
      <div className="py-[110px] bg-ga-light-green">
        <div className="px-[20px] lg:px-[280px]">
          ...
          <p className="text-center pt-6 text-[#36485C] lg:text-[18px] lg:leading-7">
            ...
            AI. Menguasai teknologi ini dapat membuka peluang karier di industri
        ...
        <div className="flex w-full flex-col items-center pt-8 gap-x-6">
          <Link href="https://ppij.org/AIPSEPPIJGenAI">
            <span className="bg-[#1b4a49] py-4 px-8 text-white rounded-[4px] lg:w-fit">
              Registrasi Sekarang
            </span>
          </Link>
        </div>
      ...
      <div>
        <div className="w-full pb-10 pt-20 px-6 max-w-7xl mx-auto flex-col flex gap-10">
          ...
          <div>
            <h2 className="text-2xl text-[#36485C] lg:leading-6">Kegiatan</h2>
            <div className="pl-5">
              <div className="pt-10">
                <p>
