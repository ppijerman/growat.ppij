...
export default function MentorsCarousel() {
	...
	return (
		...
		// </section>
		<div>
			<div className="flex flex-col items-center bg-ga-light-green">
				<h1 className="text-3xl md:text-5xl text-white font-bold pt-10">
					Our Mentors
				</h1>
				<div className='flex flex-wrap items-center justify-center overflow-y-auto gap-2 m-10  max-h-120 bg-ga-green/15 rounded-2xl'>
					{MentorsList.map((mentor, index) => (
													<Card key={index} className="flex flex-col items-center my-2 bg-transparent border-0 shadow-none">
														<CardHeader className="flex justify-center py-4">
															<Image
																src={mentor.image}
																alt={mentor.name}
