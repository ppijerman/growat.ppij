...
const iconClasses =
  "w-[50px] h-[50px] sm:w-[70px] sm:h-[70px] md:w-[80px] md:h-[80px] lg:w-[80px] lg:h-[80px]"
      ...
      <div className="md:flex lg:col-2 lg:row-1">
        ...
        <div className="lg:w-1/2 w-full">
          <div className="flex bg-gradient-to-r from-ga-blue to-[#a2d3bc] pl-3 sm:p-3 h-1/4 items-center justify-center">
            <h1 className="text-wrap text-3xl lg:text-5xl text-ga-beige font-bold pt-3">What is Step Up <br/> Mentorship 3.0</h1>
          </div>
          ...
          <div className="flex flex-col items-center justify-center p-5 bg-ga-light h-3/4">
            <p className='leading-7 lg:pt-5 lg:mb-5 sm:text-lg lg:text-2xl'>
              <b>Step Up Mentorship 3.0</b> adalah program <i>mentoring</i> intensif GRATIS yang berlangsung selama 3 minggu, 
              yang mencakup berbagai kegiatan, seperti <i>summit</i>, sesi <i>group mentoring</i>, dan sesi <i>one-on-one</i> dengan profesional dari berbagai industri.
            </p>
            <p className='leading-7 sm:text-lg lg:text-2xl'>
            <b>Tujuan kami</b> <br/>Membantu dan mendampingi mahasiswa Indonesia di Jerman untuk memperoleh <b>wawasan</b>, 
            sehingga dapat <b>berkembang</b> menjadi <b>profesional yang percaya diri</b> dan <b>siap menghadapi dunia kerja</b>.
            </p>
          </div>
        </div>
